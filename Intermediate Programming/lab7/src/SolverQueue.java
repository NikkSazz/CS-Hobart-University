...
/**
 * Solve a maze using a queue to hold the discovered rooms. (depth-first search)
 * 
 * @author Nikolai Sazonov
 */
public class SolverQueue extends SolverSubject implements Solver {
